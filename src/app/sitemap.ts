...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/aktuality`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${baseUrl}/chcibytinstruktor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/lokality`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/leto`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
