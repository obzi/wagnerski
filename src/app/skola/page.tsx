  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden mt-[52px]">
        <ProtectedImage
          src="https://images.unsplash.com/photo-1565992441121-4367c2967103?w=1600&q=85&fit=crop"
          fill
          alt="Lyžařská škola Sherpa - výuka lyžování"
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-7 sm:px-9 pb-10 max-w-[1280px] mx-auto">
          ...
          <p className="text-[14px] text-white/70 max-w-lg">
            Výuka lyžování, snowboardu a telemarku v Jeseníkách. Pouze akreditovaní instruktoři.
          </p>
        </div>
      </section>
