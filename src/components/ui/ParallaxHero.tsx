...
export function ParallaxHero() {
  ...
  return (
    <section ref={ref} className="relative h-[calc(100svh-52px)] min-h-[480px] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[rgb(8,10,6)]/70 via-[rgb(8,10,6)]/35 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-[200px] bg-gradient-to-t from-[rgb(8,10,6)]/60 to-transparent" />
